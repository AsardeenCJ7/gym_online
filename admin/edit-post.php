...
<body class="app sidebar-mini rtl">
    ...
    <marquee onMouseOver="this.stop()" style="color: #e92f33;" onMouseOut="this.start()">This is a Code Camp BD's free
        source code for educational use only. It can never be used for commercial purposes. Don't forget to take code
        camp BD permission if needed!</marquee>
                  ...
                  ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="package" id="package" class="form-control">
                                    <option value="<?php echo $result->id;?>"><?php echo $result->PackageName;?>
                                    </option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="packageduratiobn" name="packageduratiobn"
                                    placeholder="Enter Package Duratiobn"
                                    value="<?php echo $result->PackageDuratiobn;?>">
                            </div>
                  ...
                  <input class="form-control" type="file" name="photo" id="photo">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea name="description" id="description" class="form-control" cols="5"
                                    rows="10"><?php echo $result->Description;?></textarea>
                            </div>
