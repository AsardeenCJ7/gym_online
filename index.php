...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha384-c9b3e2e0a731c51e8ca933a8b3d86b9e6e67b37b957a01ff0f23a70618a6359c" crossorigin="anonymous">
    <!-- Stylesheets -->
...
<body>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                ...
                                <p class="text-uppercase text-secondary mb-0">Johnson</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                ...
                <div id="tab-2" class="tab-pane fade p-0">
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">6.00am - 8.00am</h6>
                                <h5 class="text-uppercase text-primary">Power Lifting - 2</h5>
                                <p class="text-uppercase text-secondary mb-0">Arnold</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">8.00am - 10.00am</h6>
                                <h5 class="text-uppercase text-primary">Body Building</h5>
                                <p class="text-uppercase text-secondary mb-0">John cena</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">10.00am - 12.00pm</h6>
                                <h5 class="text-uppercase text-primary">Cardio Program</h5>
                                <p class="text-uppercase text-secondary mb-0">Rock</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">12.00pm - 2.00pm</h6>
                                <h5 class="text-uppercase text-primary">Weight Loose</h5>
                                <p class="text-uppercase text-secondary mb-0">Roni cal man</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">8.00pm - 10.00pm</h6>
                                <h5 class="text-uppercase text-primary">Yoga Class</h5>
                                <p class="text-uppercase text-secondary mb-0">Undertaker</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">6.00am - 8.00am</h6>
                                <h5 class="text-uppercase text-primary">Power Lifting</h5>
                                <p class="text-uppercase text-secondary mb-0">Alan</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">8.00am - 10.00am</h6>
                                <h5 class="text-uppercase text-primary">Body Building</h5>
                                <p class="text-uppercase text-secondary mb-0">Nolan</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
                                <h6 class="text-uppercase text-light mb-3">4.00pm - 6.00pm</h6>
                                <h5 class="text-uppercase text-primary">Crossfit Class</h5>
                                <p class="text-uppercase text-secondary mb-0">Parker</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="bg-dark rounded text-center py-5 px-3">
    ...
    <div class="mb-5 text-center">
        <h5 class="text-primary text-uppercase">Experience</h5>
        <h1 class="display-3 text-uppercase mb-0">About US</h1>
    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex">
                    ...
                    <div class="ps-4">
                        ...
                        <h1 class="display-5 text-white mb-0" data-toggle="counter-up">3500 +</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
    ...
    <section class="">
        <div class="customer-feedback" style="">
            <div class="container mb-5 text-center">
                <div class="row feedrow">
                    <div class="col-sm-offset-2 col-sm-8">
                        <div class="text-center">
                            <h5 class="text-primary text-uppercase mt-5">feedback</h5>
                    ...
                    <div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
                        <div class="owl-carousel feedback-slider">
                            ...
                            <div class="feedback-slider-item">
                                ...
                                <h3 class="customer-name">Adam Riswan</h3>
                                <p>Fitness Fusion Hub has been a game-changer for me! The trainers are incredibly
                                    knowledgeable, and the variety of classes keeps my workouts interesting. I've seen
                                    amazing results, and the friendly atmosphere makes every session enjoyable.
                                </p>
                            ...
                            <div class="feedback-slider-item">
                                <img src="https://res.cloudinary.com/hnmqik4yn/image/upload/c_fill,fl_force_strip,h_128,q_100,w_128/v1493982718/ah57hnfnwxkmsciwivve.jpg"
                                    class="center-block img-circle" alt="Customer Feedback">
                                <h3 class="customer-name">Vijay</h3>
                                <p>I love the energetic vibe at Fitness Fusion Hub! The classes are challenging yet fun.
                                    The trainers are motivating, and the facilities are top-notch. The only improvement
                                    I'd suggest is adding more flexibility in class timings.
                                </p>
                            ...
                            <div class="feedback-slider-item">
                                ...
                                <p>Fitness Fusion Hub is not just a gym; it's a community. The staff is friendly, and
                                    the personalized workout plans have helped me achieve my fitness goals. The gym is
                                    always clean and well-maintained. Highly recommend it!
                                </p>
                                <span class="light-bg customer-rating" data-rating="5">
                                    5
                                    <i class="fa fa-star"></i>
    ...
    <div class="container-fluid p-5">
        ...
        <div class="team-col">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="./img/trainer/1.png" alt="Card image cap">
                <div class="card-body">
                    <h5 style="text-align:center;">Villiam Johnson</h5>
                    <p class="card-text" style="text-align:justify;">With a passion for holistic wellness, Sarah
                        specializes in creating customized
                        fitness plans tailored to individual needs. Her expertise lies in strength training and
                        functional workouts. Whether you're a beginner or an experienced fitness enthusiast, John is
                        committed to helping you achieve your goals and enjoy the journey to a healthier lifestyle</p>
                </div>
            </div>

            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="./img/trainer/2.png" alt="Card image cap">
                <div class="card-body">
                    <h5 style="text-align:center;">Alex Rodriguez</h5>
                    <p class="card-text" style="text-align:justify;">Alex is dedicated to promoting a balanced approach
                        to fitness and nutrition. His dynamic workout routines combined with nutritional guidance aim to
                        optimize overall health. He believes that fitness should be enjoyable, and his upbeat
                        personality ensures that every session is motivating and fun</p>
                </div>
            </div>

            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="./img/trainer/3.png" alt="Card image cap">
                <div class="card-body">
                    <h5 style="text-align:center;">Jason Williams</h5>
                    <p class="card-text" style="text-align:justify;">Jason brings intensity and passion to his training
                        sessions, drawing inspiration from CrossFit principles. Specializing in high-intensity interval
                        training (HIIT), Jason helps clients push their limits and achieve peak performance. If you're
                        looking for a challenging yet rewarding fitness experience, Jason is your go-to trainer.</p>
                </div>
            </div>

            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="./img/trainer/4.png" alt="Card image cap">
                <div class="card-body">
                    <h5 style="text-align:center;">Mike Thompson</h5>
                    <p class="card-text" style="text-align:justify;">Mike is passionate about building functional
                        strength and optimizing athletic performance. His expertise lies in designing strength and
                        conditioning programs that cater to diverse fitness levels. If you're an athlete or simply
                        aiming to enhance your overall strength, Mike's knowledge and dedication will guide you on the
                        path to success.</p>
                </div>
            </div>
