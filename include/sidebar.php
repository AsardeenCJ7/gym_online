...
<head>
    <title>FFH | Gym Management System</title>
    <meta charset="UTF-8">
    <meta name="description" content="FFH Fitness Fusion Hub Fitness - Center">
                                ...
                                <div class="hs-text-warp">
                                    <div class="hs-text">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            ...
                                            quis nos-trud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                                            consequat. </p>
            ...
            <div class="footer-bottom">
                <div class="row">
                    ...
                    <div class="col-md-8 text-md-right">
                        <div class="copyright">
                            Copyright All rights reserved | Developed By : <i class="fa fa-heart-o"
                                aria-hidden="true"></i> by <a href="http://www.youtube.com/@infinitivescript"
                                target="_blank">Infinitive Script</a></div>
                    </div>
                </div>
            </div>
        </div>
