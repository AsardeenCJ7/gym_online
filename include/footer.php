        ...
        <div class="footer-bottom">
            <div class="row">
                ...
                <div class="col-md-8 text-md-right">
                    <div class="copyright">
                        Fitness Fusion Hub <?php echo date('Y') ?></div>
                </div>
            </div>
        </div>
    </div>
...
<!-- Footer Start -->
<div class="container-fluid bg-dark text-secondary px-5 mt-5" style="margin-bottom: 0px !important;">
    <div class="row gx-5">
    ...
    <div class="row gx-5">
        <div class="col-lg-8">
            <div class="py-lg-4 text-center">
                <p class="text-secondary mb-0">&copy; <a class="text-light fw-bold" href="#">Fitness Fusion Hub</a>. All
                    Rights Reserved.</p>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="py-lg-4 text-center credit">
                <p class="text-light mb-0">Designed by <a class="text-light fw-bold" href="#">Infinitive Script</a></p>
            </div>
        </div>
    </div>
</div>
